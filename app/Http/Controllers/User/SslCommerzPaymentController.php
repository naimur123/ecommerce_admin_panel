...
class SslCommerzPaymentController extends Controller
{
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['total_amount'] = $reqData['total_amount']; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique
        $post_data['invoice_no'] = Str::random(8); // tran_id must be unique
    ...
    public function successes(Request $request)
    {
            ...
            if ($validation == TRUE) {
                ...
                */
                $update_product = DB::table('orders')
                    ...
                    Alert::success('Success','Your Order is been placed');
                    session()->forget('cart');
