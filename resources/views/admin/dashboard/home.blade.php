...
<div class="row">
        ...
        <div class="col-md-4 col-12">
            <div class="card bg-success bg-gradient">
                ...
                <div class="card-footer text-center">
                    <a href="{{ route('admin.customer') }}" class="text-white text-decoration-none">All Orders</a>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="col-md-4 col-12">
            <div class="card bg-info bg-gradient">
                ...
                @if(auth()->user()->can('Order view'))
                <div class="card-footer text-center">
                    <a href="{{ route('admin.customer') }}" class="text-white text-decoration-none">Today Orders</a>
                </div>
                @endif
            </div>
        </div>
