            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ $form_url }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Vendor Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="vendor_details" class="col-md-4 col-form-label text-md-end">{{ __('Vendor Details') }}</label>
